...
#define LEFT_REFLECTANCE_PIN A8
#define RIGHT_REFLECTANCE_PIN A9
#define COLOR_SENSOR_LED_PIN 2

#define PROXIMITY_PIN A10
#define PROXIMITY_PIN_5V 6
#define HIGHDISTANCE_BOTTOM_PIN A12
#define HIGHDISTANCE_BOTTOM_PIN_5V 22
#define HIGHDISTANCE_TOP_PIN A14
#define HIGHDISTANCE_TOP_PIN_5V 26
